...
scopelayer = DrawingLayer(winsize) #same as window size


#(postion/coordinates, diameter, Color, Kapal ng line)
scopelayer.circle(center, 50, Color.BLACK, width = 3) 
scopelayer.circle(center, 100, Color.BLACK, width = 2)
scopelayer.line((center[0], center[1] - 50),(center[0], 0), Color.BLACK, width = 2)
scopelayer.line((center[0],center[1] + 50), (center[0], winsize[1]), Color.BLACK, width = 2)
scopelayer.line((center[0] - 50, center[1]), (0, center[1]), Color.BLACK, width=2)
scopelayer.line((center[0] + 50, center[1]), (winsize[0], center[1]), Color.BLACK, width = 2)
...
def temp_reading():
    ...
    lcd.lcd_display_string(str(tc), 2)
