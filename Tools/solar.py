...
class Solar:
    ...
    def initialize_scope_layer(self):
        ...
        self.__scope_layer.circle(self.window_center, 50, Color.BLACK, width=3)
        self.__scope_layer.circle(self.window_center, 100, Color.BLACK, width=2)
        self.__scope_layer.line((self.window_center[0], self.window_center[1]-50),(self.window_center[0], 0), Color.BLACK, width=2)
        self.__scope_layer.line((self.window_center[0], self.window_center[1]+50), (self.window_center[0], self.window_size[1]), Color.BLACK, width=2)
        self.__scope_layer.line((self.window_center[0]-50, self.window_center[1]), (0, self.window_center[1]), Color.BLACK, width=2)
        self.__scope_layer.line((self.window_center[0]+50, self.window_center[1]), (self.window_size[0], self.window_center[1]), Color.BLACK, width=2)
